        ...
        <table className="min-w-full divide-y divide-gray-200 bg-white">
          <thead className="bg-gradient-to-r from-indigo-500 to-blue-500 text-white sticky top-0 z-10">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider">Cerrado por</th>
          ...
          <tbody className="divide-y divide-gray-100">
            {incidencias.map((incidencia, idx) => {
              return (
                ...
                >
                  <td className="px-4 py-2 font-mono text-xs">{incidencia.creation_date.split('T')[0]}</td>
                  ...
                  <td className="px-4 py-2 font-mono text-xs">{incidencia.closure_user_code}</td>
                  ...
                  <td className="px-4 py-2 text-center"> 
                    {counts[incidencia.code] ? counts[incidencia.code].people : '...'}
                  </td>
                  <td className="px-4 py-2 text-center"> 
                    {counts[incidencia.code] ? counts[incidencia.code].vehicles : '...'}
                  </td>
