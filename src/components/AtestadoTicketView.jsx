...
const AtestadoTicketView = ({ atestado, diligencias, onClose }) => {
  ...
  const generateTicketId = () => {
    return `TK-${atestado.numero}-${Date.now().toString().slice(-6)}`;
  };
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 max-h-[90vh] overflow-hidden">
        ...
        <div className="ticket-print-mode overflow-y-auto max-h-[70vh]">
          ...
          <div className="police-ticket-header">
            ...
            <div className="ticket-number">N° {atestado.numero}</div>
          ...
          <div className="ticket-section">
            ...
            <div className="ticket-field">
              ...
              <span className="ticket-field-value">{atestado.numero}</span>
            </div>
            <div className="ticket-field">
          ...
          {diligencias && diligencias.length > 0 && (
            <div className="ticket-section">
              ...
              {diligencias.map((diligencia, index) => (
                <div key={diligencia.id} className="ticket-diligencia">
          ...
          <div className="ticket-barcode">
            ...
            <div style={{ marginTop: '1mm' }}>
              {atestado.numero}-{new Date().getFullYear()}
            </div>
          </div>
          ...
          <div className="ticket-footer">
            ...
            <div style={{ fontSize: '6px', marginTop: '1mm', color: '#666' }}>
              Total hojas: {diligencias.length + 1}
            </div>
          </div>
        </div>
